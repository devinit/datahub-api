...
import {
    ICategoricalMapping, IColorMap, IColorScaleArgs, IDataRevolution,
    ILinearLegendArgs, IMapDataWithLegend, IProcessScaleData, IRAWDataRevolution,
    IRAWMapData, IScaleThreshold
} from './types';
